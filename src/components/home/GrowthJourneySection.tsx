      ...
      <div className="max-w-[1300px] mx-auto px-2 sm:px-4 lg:px-6 relative z-10">
        ...
        {recommendedProgram && userProfile?.role && userProfile?.experience && userProfile?.goal && (
          <div className="max-w-3xl mx-auto mb-8 text-center">
            <p className="text-slate-800 text-base bg-white py-3 px-6 rounded-xl shadow-lg border border-gray-200">
        ...
        {/* Timeline Navigation */}
        <div className="mb-8 flex items-center justify-center gap-0 flex-wrap">
            ...
            return (
              <div key={stage.id} className="flex items-center">
                ...
                >
                  ...
                  {recommendedProgram === stage.id && (
                    <span className="absolute -top-2 -right-2 bg-accent text-white text-xs px-2 py-1 rounded-full font-semibold animate-pulse">
                      For you
                    </span>
                  )}
                </button>
        ...
        <div className="relative">
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full p-3 shadow-xl disabled:opacity-50 disabled:cursor-not-allowed hover:scale-110 transition-transform hidden lg:block"
          >
              ...
              return (
                ...
                >
                  <div className="bg-white rounded-3xl p-6 sm:p-8 lg:p-12 shadow-2xl max-w-5xl mx-auto">
                    {/* Header Card */}
                    <div className={`bg-gradient-to-r ${stage.gradient} text-white rounded-2xl p-8 mb-8`}>
                      <div className="flex items-center gap-3 mb-2">
                        <StageIcon className="w-8 h-8" />
                        <h3 className="text-2xl sm:text-3xl font-bold">{stage.name.toUpperCase()}</h3>
                      </div>
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full p-3 shadow-xl disabled:opacity-50 disabled:cursor-not-allowed hover:scale-110 transition-transform hidden lg:block"
          >
