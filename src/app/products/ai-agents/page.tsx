      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-text-header text-white rounded-2xl p-12 text-center">
            ...
            <h3 className="text-2xl font-bold mb-4">AI Agents Coming Soon</h3>
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              We're building intelligent assistants trained on real design leadership experience. Be the first to know when they launch.
            </p>
